...
module.exports = merge(common, {
  ...
  output: {
    ...
    filename: "[name].[contentHash].bundle.js", // 번들링 된 결과 파일의 이름
    path: path.resolve(__dirname, "dist"),
  },
  // sass-loader v7.3.0 이상에서는 Minimize를 해주기 때문에, 이렇게 CSS/JS두개를 따로 써줄 필요가 없어졌다.
  //   optimization: {
